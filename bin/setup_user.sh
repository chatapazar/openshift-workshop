...
oc login -u user3 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user3
oc login -u user4 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user4
oc login -u user5 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user5
oc login -u user6 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user6
oc login -u user7 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user7
oc login -u user8 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user8
oc login -u user9 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user9
oc login -u user10 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user10
oc login -u user11 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user11
oc login -u user12 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user12
oc login -u user13 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user13
oc login -u user14 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user14
oc login -u user15 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user15
oc login -u user16 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user16
oc login -u user17 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user17
oc login -u user18 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
oc new-project user18
oc login -u user19 -p 0EsMPHqqNMBq8Ed4 --insecure-skip-tls-verify
